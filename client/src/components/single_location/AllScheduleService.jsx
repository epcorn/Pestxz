        ...
        <div className="mb-1">
          <div className="overflow-hidden rounded-lg border border-neutral-300 bg-white shadow-sm">
            <table className="w-full border-collapse text-left">
              {/* DESKTOP HEADER */}
              <thead className="hidden md:table-header-group bg-neutral-100 border-b border-neutral-300 text-xs font-bold uppercase tracking-wider text-neutral-800">
                <tr>
              ...
              {/* BODY */}
              <tbody className="divide-y overflow-y-auto max-h-[500px] block md:table-row-group">
