                        ...
                        <td colSpan="6" className="p-3 md:p-5 border-t border-neutral-300 block md:table-cell">
                          <div className="space-y-3 md:space-y-4">
                            {service.regularService[0].scopes?.map((sc, i) => (
                              <div
                                key={i}
                                className="border border-neutral-700 rounded-lg bg-white p-3 md:p-4 shadow-xs"
                              >
                                <h2 className="font-bold text-sm text-neutral-900 mb-3 border-b pb-2">
                                  {sc.scopeName}
                                </h2>
                                ...
                                <div className="space-y-1">
                                  {sc.consumables?.map((con, j) => (
                                    <div
                                      key={j}
                                      className="grid grid-cols-3 md:grid-cols-6 gap-3 border border-neutral-500 rounded-lg p-3 bg-neutral-50 whitespace-pre-wrap"
                                    >
                                      <div className="col-span-full flex flex-wrap items-center gap-2 border-b pb-1">
                                      ...
                                      <div className="col-span-2">
                                        ...
                                        <p className="text-sm font-bold text-neutral-900" title={con.comment}>
                                          {con.comment || "-"}
                                        </p>
                                      </div>
                                    </div>
