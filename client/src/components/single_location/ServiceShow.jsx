...
export function ScheduleDatePills({ scheduleList, nextDate, todaysDate }) {
  return scheduleList?.map((n, i) => {
                  ...
                  <tr key={index} className="border-b border-black last:border-b-0 *:px-2 py-2">
                    ...
                    <td className="border-r border-black">
                      <div className="flex flex-wrap gap-2 min-w-[200px] p-1 max-h-20 text-xs font-semibold overflow-auto items-center">
                        ...
                        ) : nextServices.length === 0 && schedules.length > 0 ? (
                          <div className="flex flex-wrap items-center gap-2">
                            {!isExpanded && <span>No services pending</span>}
                            {isExpanded && (
                              <ScheduleDatePills
